...
| --- | --- | --- | --- | --- | --- |
| UC-001 | Daily Global Review | Tägliche Weltkarten-/Statusübersicht prüfen; welche Länder zeigen neue Auffälligkeiten? | ja | World Anomaly Map | Karte; aktive/anomale Domänen; Datenlücken; Top-Statusänderungen; Drill-down |
| UC-002 | Country Deep Dive | Land auswählen und erklären, warum es auffällig, unauffällig oder nicht bewertbar ist. | ja | Country Profile | D0–D5 je Domäne; Treiber; Gegenindikatoren; Jahresverläufe; Events; Annotation |
