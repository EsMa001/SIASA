...
- therefore the next serial planning focus is AP-18: surface AP-16/AP-17 operator signals directly in readiness UX so no-go triage is actionable without raw artifact inspection, before adding further convenience layers
