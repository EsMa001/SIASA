...
>
> Project-lead communication shortcut: `docs/plans/siasa-next-big-packages-executive-view.md` provides a one-page summary of the next large package families (currently G1/G3/G4/G2-trigger/G5) and their recommended order.
>
