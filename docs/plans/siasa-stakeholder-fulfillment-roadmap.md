...
- AP-24 is now closed: release-failure drill now also emits `operator_remediation_execution_loop`, turning AP-22 priorities and AP-23 movement rows into explicit next-up/queued actions with closure targets and evidence sources visible in drill outputs and readiness GUI.
- next serial planning focus should now be chosen after AP-24 closure review
