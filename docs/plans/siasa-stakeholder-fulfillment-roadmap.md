...
- therefore the next serial planning focus is AP-16: keep the capability-vs-readiness split operator-actionable by adding concise failure interpretation/remediation context on top of gate diagnostics, before adding further convenience layers
