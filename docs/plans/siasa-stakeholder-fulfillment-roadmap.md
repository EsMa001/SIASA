...
- Near-term closure band:
  - continue the curated validation library from the completed first and Middle East / energy P2 tranches into the remaining extended-focus fragility/crisis tranche (`NGA`, `SDN`, `MMR`) unless broader MVP/P2 runtime breadth becomes higher-value than finishing the governed validation portfolio
