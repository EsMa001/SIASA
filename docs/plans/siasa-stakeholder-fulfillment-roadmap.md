...
- AP-21 is now closed: readiness GUI now surfaces AP-19 trend baseline plus AP-20 stale-remediation closure guardrail breaches in operator steering; next serial planning focus is AP-22 recurrence-aware remediation prioritization
