...
- Near-term closure band:
  - choose the next priority between expanding breadth beyond the now-complete core-focus subset into broader MVP/P2 scope and broadening the curated validation library beyond the first challenge/mismatch cases
