...
| AC-008 | StR-089..117; StR-575..578 | Startseite zeigt Weltkarte. | GUI-Test | Karte färbt Länder nach Multi-Domain-Status, nutzt relative Baseline und erlaubt Drill-down nur für verfügbare Country Profiles; die Startseite enthält keine dead links zu nicht generierten Länderansichten. | MVP-Must |
| AC-009 | StR-018..023; StR-579 | Country Profile ist verfügbar. | GUI-Test | Landesprofil zeigt Multi-Domain-Status, D0–D5 je Domäne, Treiber, Gegenindikatoren, Coverage, Confidence und Events, ist über den unterstützten Drill-down erreichbar und bietet funktionierende Rücknavigation zu den zentralen Übersichtsseiten. | MVP-Must |
