...
def test_daily_run_orchestrator_writes_gui_artifact_bundle_after_successful_run(tmp_path: Path) -> None:
    ...
    assert traceability_integrity["summary"]["requirement_count"] == 109
    ...
    assert repo_closure["summary"] == {"slice_count": 18, "requirement_count": 109, "closed": 109, "at_risk": 0}
...
def test_daily_run_orchestrator_writes_country_specific_multi_country_artifact_statuses(tmp_path: Path) -> None:
    def _country_specific_domain_status(domain: str, features, records=None):
