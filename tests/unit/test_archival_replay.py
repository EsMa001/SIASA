...
def test_load_governed_historical_replay_inputs_prefers_archival_provider_backed_cases_for_all_curated_cases() -> None:
    ...
    assert replay_inputs["VAL-USA-2024-001"].review_basis == "provider_backed_archival_replay"
    assert replay_inputs["VAL-DEU-2024-001"].review_basis == "provider_backed_archival_replay"
    assert replay_inputs["VAL-EST-2024-001"].review_basis == "provider_backed_archival_replay"
    assert replay_inputs["VAL-FIN-2024-001"].review_basis == "provider_backed_archival_replay"
    ...
    assert replay_inputs["VAL-USA-2024-001"].replay_input_source_ids == [
        "SRC-GDACS",
        "SRC-GDELT-DOC",
        "SRC-GDELT-EVENTS",
        "WB-INDICATORS",
    ]
    assert replay_inputs["VAL-DEU-2024-001"].replay_input_source_ids == [
        "SRC-GDACS",
        "SRC-GDELT-DOC",
        "SRC-GDELT-EVENTS",
        "WB-INDICATORS",
    ]
    assert replay_inputs["VAL-EST-2024-001"].replay_input_source_ids == [
        "SRC-GDACS",
        "SRC-GDELT-DOC",
        "SRC-GDELT-EVENTS",
        "WB-INDICATORS",
    ]
    assert replay_inputs["VAL-FIN-2024-001"].replay_input_source_ids == [
        "SRC-GDACS",
        "SRC-GDELT-DOC",
        "SRC-GDELT-EVENTS",
        "WB-INDICATORS",
    ]
    assert replay_inputs["VAL-SAU-2024-001"].replay_input_source_ids == [
        "SRC-GDACS",
        "SRC-GDELT-DOC",
        "SRC-GDELT-EVENTS",
        "WB-INDICATORS",
    ]
    assert replay_inputs["VAL-QAT-2024-001"].replay_input_source_ids == [
        "SRC-GDACS",
        "SRC-GDELT-DOC",
        "SRC-GDELT-EVENTS",
        "WB-INDICATORS",
