...
def test_stakeholder_system_traceability_report_covers_all_active_stakeholders() -> None:
    ...
    assert report["summary"]["active_stakeholder_requirement_count"] == 677
    assert report["summary"]["system_requirement_count"] == 53
    assert report["summary"]["covered_by_system_requirement_count"] == 677
    assert report["summary"]["covered_by_traceability_count"] == 677
