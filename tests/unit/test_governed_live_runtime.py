...
def test_governed_live_orchestrator_can_write_artifacts_with_real_source_ids(tmp_path: Path) -> None:
    ...
    assert validation_backtest["historical_replay_summary"] == {
        ...
        "status_match_count": 12,
        "average_domain_match_ratio": 0.92,
        "average_replay_evidence_score": 0.93,
        "average_replay_source_coverage_ratio": 0.92,
        "average_replay_provenance_completeness_ratio": 1.0,
        "replay_input_record_total": 91,
        "archival_data_file_count": 13,
        "replay_evidence_tier_counts": {
            "strong_replay_evidence": 1,
            "verified_replay_evidence": 11,
        ...
        "review_basis_counts": {
            "provider_backed_archival_replay": 13,
        },
