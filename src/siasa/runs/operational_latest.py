...
def build_operational_latest_bundle(
    *,
    ...
    run_history_writer(
        ...
        countries_without_updates_count=int(verification_summary.get("countries_without_updates_count", 0) or 0),
    ...
    recent_runs = [
        {
            ...
            "countries_without_updates_count": entry.countries_without_updates_count,
