...
- `vmodel/traceability/implementation_file_links.yaml` – aktuell mit governed Slices `catalog-and-ingestion-foundation`, `gui-readmodels-and-annotations`, `governance-and-run-controls`, `normalization-and-mapping`, `reporting-and-export` und `validation-and-backtest`
